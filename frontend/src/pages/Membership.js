      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-400 rounded-2xl p-6 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-green-800">Membership Fees</h3>
              <p className="text-green-700 text-lg">
                <span className="font-bold text-2xl">₹5,000</span> - Lifetime membership fees for all SESI activities and events
              </p>
            </div>
          </div>
        </div>
