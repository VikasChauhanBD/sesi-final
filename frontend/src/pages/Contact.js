      ...
      <section className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-white/90 max-w-2xl">
            Get in touch with SESI for membership inquiries, event information, or any other questions.
          </p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <a href="mailto:info@sesi.co.in" className="text-orange-600 hover:text-orange-700 font-medium">
                info@sesi.co.in
              </a>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <h3 className="font-bold text-gray-900 mb-2">Membership</h3>
              <p className="text-gray-600 text-sm mb-2">For membership queries:</p>
              <a href="mailto:membership@sesi.co.in" className="text-orange-600 hover:text-orange-700 font-medium">
                membership@sesi.co.in
              </a>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <p className="text-gray-600 text-sm mb-2">Official website:</p>
              <a href="https://sesi.co.in" className="text-orange-600 hover:text-orange-700 font-medium">
                www.sesi.co.in
              </a>
            </div>
