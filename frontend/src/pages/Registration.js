    ...
    <div className=\"min-h-screen bg-gray-50 py-12\">
      <div className=\"container mx-auto px-4 max-w-4xl\">
        <div className=\"bg-white rounded-2xl shadow-xl p-8 md:p-12\">
          <h1 className=\"text-4xl font-bold text-gray-900 mb-2\" data-testid=\"registration-title\">Membership Application Form</h1>
          <p className=\"text-gray-600 mb-8\">Join the Shoulder & Elbow Society of India</p>

          {/* Success Message */}
          {success && (
            <div className=\"bg-green-50 border-2 border-green-500 rounded-xl p-6 mb-8\" data-testid=\"success-message\">
          ...
          {/* Error Message */}
          {error && (
            <div className=\"bg-red-50 border-2 border-red-500 rounded-xl p-6 mb-8\" data-testid=\"error-message\">
              ...
              <div className=\"grid grid-cols-1 md:grid-cols-2 gap-6\">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className=\"w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent\"
                    data-testid=\"medical-council-input\"
                  />
                </div>
              </div>
            </div>
                ...
                <div className=\"grid grid-cols-1 md:grid-cols-3 gap-6\">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      data-testid=\"comm-district-select\"
                    >
                ...
                <div className=\"grid grid-cols-1 md:grid-cols-3 gap-6\">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className=\"w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent disabled:bg-gray-100\"
                      data-testid=\"work-district-select\"
                    >
                      <option value=\"\">Select District</option>
              ...
              <div className=\"grid grid-cols-1 md:grid-cols-2 gap-6\">
                ...
                <div className=\"md:col-span-2\">
                  ...
                  <input
                    ...
                    required
                    className=\"w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent\"
                    data-testid=\"state-reg-file-input\"
                  />
                </div>
              </div>
            </div>
