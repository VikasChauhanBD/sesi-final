        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              The Shoulder and Elbow Society of India is dedicated to advancing education, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.path}>
                  <Link to={link.path} className="text-gray-400 hover:text-orange-500 transition text-sm">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@sesi.co.in" className="hover:text-orange-500 transition">
                  info@sesi.co.in
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="https://sesi.co.in" className="hover:text-orange-500 transition">
                  www.sesi.co.in
                </a>
              </li>
            </ul>
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>© {new Date().getFullYear()} Shoulder and Elbow Society of India. All rights reserved.</p>
            <div className="flex gap-6">
              <Link to="/privacy" className="hover:text-orange-500 transition">Privacy Policy</Link>
              <Link to="/terms" className="hover:text-orange-500 transition">Terms of Use</Link>
            </div>
          </div>
        </div>
      </div>
