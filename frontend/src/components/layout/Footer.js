    ...
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-orange-400">About SESI</h3>
            <p className="text-gray-300 text-sm mb-4">
              The Shoulder & Elbow Society of India is dedicated to advancing the science and practice of shoulder and elbow surgery in India.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-teal-600 rounded-full flex items-center justify-center hover:bg-teal-500 transition">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/education" className="text-gray-300 hover:text-white transition">Education</Link></li>
              <li><Link to="/publications" className="text-gray-300 hover:text-white transition">Publications</Link></li>
            </ul>
          </div>

          {/* Resources */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-orange-400">Resources</h3>
            <ul className="space-y-2 text-sm">
              <li><Link to="/resources" className="text-gray-300 hover:text-white transition">Guidelines</Link></li>
              ...
              <li><Link to="/registration" className="text-gray-300 hover:text-white transition">Apply Now</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              <li className="flex items-start gap-2">
                ...
                <span>Shoulder & Elbow Society of India<br/>New Delhi, India</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@sesi.co.in" className="hover:text-white transition">info@sesi.co.in</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Shoulder & Elbow Society of India. All rights reserved.</p>
